package examples.other;// This import lets us use classes from java.util package (List, Map, etc.)
import java.util.*;
...
public class ProgrammingBasicConcepts {
	...
	private static void stringsExample() {
		...
		System.out.println("--- examples.other.Strings ---");

		// --- examples.other.Strings ---
